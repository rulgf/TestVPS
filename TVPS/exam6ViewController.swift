...
class exam6ViewController: UIViewController {
    ...
    func initImage(){
        ...
        //Obtener tu pregunta
        img0.image = UIImage(named: "TVPS_6_\(numberQuestion)_0.png")!
        images = ["1": UIImage(named: "TVPS_6_\(numberQuestion)_1.png")!,
                  "2": UIImage(named: "TVPS_6_\(numberQuestion)_2.png")!,
                  "3": UIImage(named: "TVPS_6_\(numberQuestion)_3.png")!,
                  "4": UIImage(named: "TVPS_6_\(numberQuestion)_4.png")!]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if(segue.identifier == "endTest"){
            ...
            startTestViewController.actualTest = 7
        }
    }
