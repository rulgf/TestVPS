...
class exam7ViewController: UIViewController {
    ...
    func initImage(){
        ...
        //Obtener tu pregunta
        img0.image = UIImage(named: "TVPS_7_\(numberQuestion)_0.png")!
        images = ["1": UIImage(named: "TVPS_7_\(numberQuestion)_1.png")!,
                  "2": UIImage(named: "TVPS_7_\(numberQuestion)_2.png")!,
                  "3": UIImage(named: "TVPS_7_\(numberQuestion)_3.png")!,
                  "4": UIImage(named: "TVPS_7_\(numberQuestion)_4.png")!]
