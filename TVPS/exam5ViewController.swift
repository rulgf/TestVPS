...
class exam5ViewController: UIViewController {
    ...
    func initImage(){
        timerView.isHidden = false
        timer = Timer.scheduledTimer(timeInterval:5, target: self, selector: (#selector(exam5ViewController.updateView)), userInfo: nil, repeats: true)
        
        //Obtener tu pregunta
        img0.image = UIImage(named: "TVPS_5_\(numberQuestion)_0.png")!
        images = ["1": UIImage(named: "TVPS_5_\(numberQuestion)_1.png")!,
                  "2": UIImage(named: "TVPS_5_\(numberQuestion)_2.png")!,
                  "3": UIImage(named: "TVPS_5_\(numberQuestion)_3.png")!,
                  "4": UIImage(named: "TVPS_5_\(numberQuestion)_4.png")!]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if(segue.identifier == "endTest"){
            ...
            startTestViewController.actualTest = 6
        }
    }
